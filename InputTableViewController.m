...
-(void) dummyInitModel
{
    ...
    BOOL gender = MALE;
    NSNumber *totalCholesterol = [NSNumber numberWithInt: 200];
    NSNumber *HDLCholesterol = [NSNumber numberWithInt: 200];
    BOOL smoker = true;
    NSNumber *systolicBloodPressure = [NSNumber numberWithInt: 200];
    BOOL medication = true;
    
    ScoreModel *model = [[ScoreModel alloc ] initWithAge:age
                                                  gender:gender
